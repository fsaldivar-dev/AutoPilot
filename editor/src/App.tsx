...
const AUTO_COMMANDS = [
  ...
  { label: "keychain reset", detail: "Borra el keychain compartido del simulador (iOS only — afecta TODAS las apps, util para fresh-install login flows)", insertText: "keychain reset", platform: "ios" as const },
