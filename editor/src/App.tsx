...
const AUTO_COMMANDS = [
  ...
  { label: "biometric enroll", detail: "Activar biometría" },
    ...
    monaco.languages.setMonarchTokensProvider("auto", {
      tokenizer: {
        root: [
          ...
          [/"[^"]*"/, "string"],
          [/'[^']*'/, "string"],
          [/\b(ping|tree|tap|doubleTap|longPress|type|clear|swipe|scroll|tapAt|elementAt|exists|waitFor|screenshot|launch|terminate|install|biometric|faceid|paste|openurl|media|build|camera|run|boot|shutdown|list)\b/, "keyword"],
